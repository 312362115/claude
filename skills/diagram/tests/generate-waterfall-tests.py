...
L4_DATA = '''
  const data = [
    { name: 'FY23 净利润',     value: 12000, type: 'start' },
    { name: 'SaaS 订阅收入',   value: 6800,  type: 'increase' },
    { name: '专业服务收入',     value: 3200,  type: 'increase' },
    { name: '硬件销售收入',     value: 2100,  type: 'increase' },
    { name: '技术授权费',       value: 1500,  type: 'increase' },
    { name: '投资收益',         value: 800,   type: 'increase' },
    { name: '汇兑收益',         value: 400,   type: 'increase' },
    { name: '人员薪酬',         value: -5200, type: 'decrease' },
    { name: '云基础设施成本',   value: -3800, type: 'decrease' },
    { name: '研发投入',         value: -2600, type: 'decrease' },
    { name: '市场营销费用',     value: -2200, type: 'decrease' },
    { name: '管理费用',         value: -1500, type: 'decrease' },
    { name: '折旧摊销',         value: -900,  type: 'decrease' },
    { name: '利息支出',         value: -600,  type: 'decrease' },
    { name: '所得税',           value: -1800, type: 'decrease' },
    { name: 'FY24 净利润',     value: 0,     type: 'total' }
  ];
'''
