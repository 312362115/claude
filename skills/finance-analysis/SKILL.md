...
description: >
  ...
  复盘、回看、verify、业绩验证、错判归因、命中率、季度报告、framework 升级、月度汇总、巡检、
  债券、国债、公司债、可转债、债基、TLT、IEF、LQD、HYG、TIPS、久期、YTM、信用利差、
  加息周期、降息周期、期限倒挂、垃圾债、高收益债、市政债、债券 ETF。
...
| `frameworks/bond-analysis.md` | 债券 / 债券 ETF / 可转债（久期 / 信用 / 利差三维） | 0.3.0 |
