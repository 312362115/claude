...
- **Mermaid DSL（20+ 种）** — 流程图、时序图、ER 图、类图、状态图、甘特图、思维导图、C4 架构图、桑基图、饼图等，日常优先输出 DSL，配合 preview-md 实时渲染
- **HTML + Playwright 截图（10+ 种）** — 雷达图、热力图、散点图、矩形树图、柱线混合图、Kanban、Git Graph、鱼骨图、SWOT 图、文氏图等

三种输出格式：**PNG**（默认）、**HTML**（交互式）、**Mermaid DSL**（可版本控制）
